...
export default function GeneticAlgorithmComponent() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Predicción de Horarios con Algoritmo Genético</h1>
      
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <p className="text-gray-700">Un algoritmo genético aplicado a la generación de horarios de cursos crea inicialmente varios horarios posibles de forma aleatoria. Cada uno se evalúa según qué tan bien cumple con restricciones como evitar traslapes entre cursos, respetar la disponibilidad de alumnos y profesores, y distribuir adecuadamente las clases durante la semana. Luego, los mejores horarios se seleccionan para cruzarse entre sí y producir nuevos horarios, mientras que algunas pequeñas mutaciones se aplican para mantener la diversidad. Este proceso se repite hasta obtener un horario de cursos óptimo o cercano al ideal.</p>
      </div>
  
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Columna izquierda: Agregar cursos y lista de seleccionados */}
        <div>
        ...
        {/* Columna derecha: Parámetros y resultados */}
        <div>
          <div className="bg-white rounded-lg shadow-md p-4 mb-4">
            <h2 className="text-lg font-semibold mb-4">Parámetros del Algoritmo</h2>
          ...
          {availableCourses.length > 0 && (
            <div className="bg-white rounded-lg shadow-md p-4">
              <h2 className="text-lg font-semibold mb-4">Cursos sin Conflictos</h2>
              <div className="space-y-2">
